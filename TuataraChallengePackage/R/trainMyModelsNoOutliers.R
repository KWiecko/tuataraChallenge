...
trainMyModelsNoOutliers <- function(sc, trainCase1CorrToLoss, trainIdxs ,isLossLog){
  ...
  # subseting data
  trainCase1CorrToLossFinal_subset <- getCaretDataSample(trainCase1CorrToLoss[(trainCase1CorrToLoss$id %in% trainIdxs),],
                                                         trainCase1CorrToLoss[(trainCase1CorrToLoss$id %in% trainIdxs),]$loss
                                                         , 50000, 1, 1)
